...
from agentverse.environments.tasksolving_env.rules.single_llm_benchmark import (
    SingleLLMBenchmarkRule,
    prepare_single_llm_benchmark_rule_kwargs,
)

from .. import env_registry as EnvironmentRegistry


@EnvironmentRegistry.register("task-single-llm-benchmark")
class SingleLLMBenchmarkEnvironment(BaseEnvironment):
    class Config:
        arbitrary_types_allowed = True

    rule: SingleLLMBenchmarkRule
    ...
    def __init__(self, **kwargs):
        ...
        rule = SingleLLMBenchmarkRule(
            **prepare_single_llm_benchmark_rule_kwargs(rule_config)
        )
